...
export class UniqueTotem1663298421121 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "check_in" ADD CONSTRAINT "UQ_66ad191a3827b422835037389d7" UNIQUE ("lecture", "participant")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "check_in" DROP CONSTRAINT "UQ_66ad191a3827b422835037389d7"`);
